...
OUTPUT=${PROJECT}/outputs/dynamicvla/finetune_4x50_epoch0004_nact8_20260901_mirror_parallel
SEED=20280804
TRIALS=50
EPISODE_SECONDS=15
...
GPUS=(2 3 4 5)
IMG_PORTS=(3436 3446 3456 3466)
ACT_PORTS=(3438 3448 3458 3468)
...
export HF_HOME=/data1/hxai/hf_cache
...
start_client() {
  ...
  (
    ...
    CUDA_VISIBLE_DEVICES="${GPUS[$i]}" \
      HF_ENDPOINT="$HF_ENDPOINT" HF_HOME="$HF_HOME" HF_HUB_DISABLE_TELEMETRY=1 \
      "$CONDA" run --no-capture-output -n dynamicvla \
